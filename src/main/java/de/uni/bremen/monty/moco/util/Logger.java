...
public class Logger {
	...
	public static void logErrLn(Object obj) {
		if (err != null) {
			err.println(obj);
		} else {
	...
	public static void logOutLn(Object obj) {
		if (out != null) {
			out.println(obj);
		} else {
	...
	public static void setOutStream(PrintStream stream) {
		out = stream;
	}

	public static void setErrStream(PrintStream stream) {
		err = stream;
	}
}
